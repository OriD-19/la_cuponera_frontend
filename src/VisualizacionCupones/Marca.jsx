...
export const MostrarMarcas=() => {
    return (
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3  gap-4 p-4 mt-6 px-20">
...
const Marca = () => {
    return (
        <div className="bg-primary p-4 rounded-lg shadow-md w-full h-auto flex space-x-7 justify-center object-contain">
