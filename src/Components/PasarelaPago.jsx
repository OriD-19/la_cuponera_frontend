...
import { validarVacíos, verificarNumeros,verificarFechaExpiracion } from "../validaciones";
...
export default function PasarelaPago() {
    ...
    return (
        <div className="bg-fondo shadow-md h-screen m-0 p-3">
            <div className="container mx-auto p-4 bg-gray-800 rounded-lg shadow-lg max-w-2xl mt-5 p-15 m-3">
